...
const SingleOnlineFriend = ({onlineuser_id}) => {
...
useEffect(() => {  getOnlineUsers()  },[])
 ...
 return (  <section key={currentuser?.id} className="w-full">
   { currentuser &&
        <div key={currentuser.id} className="w-full relative flex flex-col items-center">
