...
const getSearchSuggestions = async(word) => {
  ...
  return (
    <div className="w-full flex items-center justify-center relative">
        <input onChange={e => {setsearch(e.target.value); getSearchSuggestions(e.target.value)}} type="search" value={search} placeholder="Search..." className="w-10/12 mr-1 px-8 py-2 bg-inherit border-2 border-slate-400 rounded-full"/>
