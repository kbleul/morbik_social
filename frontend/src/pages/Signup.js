  ...
  return (
    ...
    <div className="flex flex-col w-2/5 ml-[30%] mt-[4%] shadow-lg bg-white">
      ...
      <form onSubmit={e => handleSubmit(e)} className="flex flex-col w-full">
        ...
        <input className="w-4/5 ml-[10%] py-2 px-4 mt-8 border-2 border-gray-300 rounded-md mb-4" type="text" value={username} placeholder="Username" name="username" onChange={e => setusername(e.target.value)} autocomplete="off" required/>
